...
<!-- form start -->
<form id="form1" action="{{url('/updateGallery')}}" name="employeeform" method="post" enctype="multipart/form-data">
<div class="box-body">
@csrf
<input id="id" name="id" placeholder="" type="hidden" class="form-control" value="@if(!empty($result1[0]['gallery']->id)){{$result1[0]['gallery']->id}}@endif">
...
@if(!empty($result1[0]['gallery']->class))
<option value="{{$result1[0]['gallery']->class}}">{{$result1[0]['gallery']->class}}</option>
@else
...
<select id="section_id" name="section" class="form-control">
    @if(!empty($result1[0]['gallery']->section))
<option value="{{$result1[0]['gallery']->section}}">{{$result1[0]['gallery']->section}}</option>
@else
<option value="">Select</option>
@endif
...
<input id="date" name="date" placeholder="" type="date" class="form-control" value="@if(!empty($result1[0]['gallery']->date)){{$result1[0]['gallery']->date}}@endif">@if(!empty($result1[0]['gallery']->date)){{$result1[0]['gallery']->date}}@endif
<span class="text-danger"></span>
</div>
<div class="form-group">
<label for="exampleInputEmail1">Title</label><small class="req"> *</small>
<input id="title" name="title" placeholder="" type="text" class="form-control" value="@if(!empty($result1[0]['gallery']->title)){{$result1[0]['gallery']->title}}@endif">
<span class="text-danger"></span>
</div>

<div class="form-group">
<label for="exampleInputEmail1">Description</label>
<textarea class="form-control" id="description" name="description" value="@if(!empty($result1[0]['gallery']->description)){{$result1[0]['gallery']->description}}@endif" placeholder="" rows="3">@if(!empty($result1[0]['gallery']->description)){{$result1[0]['gallery']->description}}@endif</textarea>
<span class="text-danger"></span>
</div>

<div class="form-group">
<label for="exampleInputEmail1">video url</label><small class="req"> *</small>
<input id="videos" name="videos" placeholder="" type="text" class="form-control" value="@if(!empty($result1[0]['gallery']->videos)){{$result1[0]['gallery']->videos}}@endif">
<span class="text-danger"></span>
</div>
...
<input type="file" id="file" name="files[]" class="form-control" value="@if(!empty($result1[0]['gallery']->photos)){{$result1[0]['gallery']->photos}}@endif" style="opacity:1 !important;" multiple>
<span class="text-danger"></span>
...
<thead>
<tr role="row"><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 100px;" aria-label="Room Number / Name: activate to sort column ascending">Class</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 100px;" aria-label="Hostel: activate to sort column ascending">Section</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 100px;" aria-label="Room Type: activate to sort column ascending">Date</th><th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 100px;" aria-label="Room Type: activate to sort column ascending">Title</th><th class="text-right no-print sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 48px;" aria-label="Action: activate to sort column ascending">Image</th><th class="text-right no-print sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 48px;" aria-label="Action: activate to sort column ascending">Action</th></tr>
</thead>
<tbody>
@if(empty($data1))
<tr class="odd">
